...
```
        ...
        {
            modelBuilder.ApplyConfiguration(new ZhiwsCfg());
        }
...
<text name="BumensId"  value="BumensId"></text>
<text name="Bumens"  value="Bumens"></text>
<text name="Shot"  value="Shot"></text>


<text name="Zhiws" value=""></text><text name="QueryZhiws"  value="查询"></text><text name="CreateZhiws"  value="添加"></text><text name="EditZhiws"  value="编辑"></text><text name="DeleteZhiws"  value="删除"></text><text name="BatchDeleteZhiws" value="批量删除"></text><text name="ExportZhiws"  value="导出"></text>                             
