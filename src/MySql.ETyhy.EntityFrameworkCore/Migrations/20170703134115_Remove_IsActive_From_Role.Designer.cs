...
{
    [DbContext(typeof(ETyhyDbContext))]
    ...
    partial class Remove_IsActive_From_Role
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("MySql.ETyhy.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("MySql.ETyhy.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("MySql.ETyhy.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("MySql.ETyhy.Authorization.Roles.Role", b =>
                {
                    ...
                    b.HasOne("MySql.ETyhy.Authorization.Users.User", "DeleterUser")
                        .WithMany()
