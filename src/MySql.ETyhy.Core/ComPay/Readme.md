...
```
        ...
        {
            modelBuilder.ApplyConfiguration(new ComasCfg());
        }
...
<text name="Comas" value=""></text><text name="QueryComas"  value="查询"></text><text name="CreateComas"  value="添加"></text><text name="EditComas"  value="编辑"></text><text name="DeleteComas"  value="删除"></text><text name="BatchDeleteComas" value="批量删除"></text><text name="ExportComas"  value="导出"></text>                             
