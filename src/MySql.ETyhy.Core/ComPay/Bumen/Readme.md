...
复制以下代码到Application层下的：ETyhyApplicationModule.cs
...
如果你生成了**权限功能**。复制以下代码到 ETyhyApplicationModule.cs
中的 PreInitialize 方法中:
...
```
        ...
        {
            modelBuilder.ApplyConfiguration(new BuMensCfg());
        }
...
<text name="TName"  value="TName"></text>
<text name="IsTopBm"  value="IsTopBm"></text>
<text name="ComasId"  value="ComasId"></text>
<text name="Comas"  value="Comas"></text>
<text name="Zhiws"  value="Zhiws"></text>
<text name="Shot"  value="Shot"></text>


<text name="BuMens" value=""></text><text name="QueryBuMens"  value="查询"></text><text name="CreateBuMens"  value="添加"></text><text name="EditBuMens"  value="编辑"></text><text name="DeleteBuMens"  value="删除"></text><text name="BatchDeleteBuMens" value="批量删除"></text><text name="ExportBuMens"  value="导出"></text>                             
